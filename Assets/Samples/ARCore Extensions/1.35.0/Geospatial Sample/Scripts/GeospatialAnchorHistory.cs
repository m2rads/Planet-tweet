...
namespace Google.XR.ARCoreExtensions.Samples.Geospatial
{
    ...
    public struct GeospatialAnchorHistory
    {
        ...
        /// <summary>
        /// Response object in json format that we recieve from Twitter 
        /// </summary>
        ...
        public GeospatialAnchorHistory(DateTime time, double latitude, double longitude,
            double altitude, Quaternion eunRotation, Status status)
        {
        ...
        public GeospatialAnchorHistory(
            double latitude, double longitude, double altitude, Quaternion eunRotation, Status status) :
            this(DateTime.Now, latitude, longitude, altitude, eunRotation, status)
        {
        }
